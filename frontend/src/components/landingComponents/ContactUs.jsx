...
const ContactUs = () => {
  ...
  const schema = yup.object().shape({
        ...
        contact: yup.string().required().min(10).max(11),
        subject: yup.string().required().min(8).max(50),
        message: yup.string().required().min(8).max(200),
      });
  ...
  return (
    ...
    <NavBar/>
     <div className="container my-5">
                 <h2 className="text-center">Admin Contact</h2>
                       ...
                       <form onSubmit={handleSubmit((d) => handleContact(d))}>
                         <div className="row g-3">
                           ...
                           <div className="col-md-12">
                             ...
                             <div className="input-group">
                               <span className="input-group-text"><MdMessage /></span>
